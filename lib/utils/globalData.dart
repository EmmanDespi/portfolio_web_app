// Copyright (c) 2025 Kivo Motion Team.
// All rights reserved.
//
// This file is part of the Kivo Motion project.  
// Unauthorized copying of this file, via any medium is strictly prohibited.  
// Proprietary and confidential.
//
// Written by Emmanuel Despi, 2025.
// Change Log - 
// 2025-15-05 Initial Project Creation
...
/// Global app colors.
/// These raw values are mirrored as semantic tokens in `PosTheme`
/// (pos_system/widgets/common_widgets.dart).  Prefer PosTheme tokens
/// inside POS pages; use AppColors only in global_data.dart widgets
/// (NeomorphismPanel, WirePanel, CenteredPanel) to avoid a circular import.
class AppColors {
  // ── Status colours ───────────────────────────────────────
  static const Color info    = Color(0xFF2F80ED);
  static const Color sucess  = Color(0xFF27AE60);   // intentional typo kept for API compat
  static const Color warning = Color(0xFFE2B93B);
  static const Color error   = Color(0xFFEB5757);

  // ── Brand palette ────────────────────────────────────────
  /// Vivid orange – primary CTA accent (= PosTheme.primary / peach).
  static const Color peach    = Color(0xFFFE8254);

  /// Muted teal-navy – text, borders, dividers (= PosTheme.dsBlue).
  static const Color dsBlue   = Color(0xFF3F5A62);

  /// Warm tan – main page/scaffold background (= PosTheme.surface / oatcream).
  static const Color oatcream = Color(0xFFC2A178);

  /// Light greige – cards, panels, input fills (= PosTheme.cardBg / oatmilk).
  static const Color oatmilk  = Color(0xFFDED8CC);
  ...
  static const Color oat = Color(0xFFDED8CC);

  /// Near-black – dark theme background/surface (onyx).
  static const Color onyx = Color(0xFF373539);
...
class AppTheme {
  ...
  /// Card / panel surface.
  Color get surface => isDark ? AppColors.onyxCard : AppColors.oatmilk;
  ...
  Color get textSecondary =>
      isDark ? AppColors.oatmilk.withValues(alpha: 0.6) : AppColors.dsBlue;
  ...
  Color get shadowDark =>
      isDark ? Colors.black.withValues(alpha: 0.5) : Colors.black.withValues(alpha: 0.22);
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: border, // ?? Border.all(color: AppColors.onyx, width: 2),
          boxShadow: [ boxShadow ??
              BoxShadow(
                color: Colors.black,
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: color ?? AppColors.oatmilk,
          borderRadius: borderRadius ?? BorderRadius.circular(12),
          border: border ?? Border.all(color: AppColors.onyx, width:1),
           boxShadow: [
              BoxShadow(
...
// /// A reusable small centered panel container for consistent sizing and style.
// /// Defaults to [AppColors.oatmilk] background (= PosTheme.cardBg).
      ...
      child: Container(
        ...
        boxShadow: [ boxShadow ??
            BoxShadow(
              ...
              blurRadius: 2.0,
              offset: Offset(1, 3)// vertical offset
            ),
          ],
        ),
        child: child,
...
// /// A reusable spacer/wrapper panel with no default padding or rounding.
// /// Defaults to [AppColors.oatmilk] background (= PosTheme.cardBg).
// /// Pass [color] to override, e.g. `AppColors.oatcream` for page-bg sections.
...
// /// Soft neumorphic card panel.
// /// Default background: [AppColors.oatmilk] (= PosTheme.cardBg).
// /// Pass [color] to override for special cases (e.g. a page-bg-coloured panel).
// /// Pass [border] to add a coloured outline (use PosTheme.border from the call site).
...
//               child: child,
//             ),
//             // Simulated inner shadow overlay
//             Positioned.fill(
//               child: IgnorePointer(
//                 child: Container(
//                   decoration: BoxDecoration(
...
// /// Pass [color] to override for special cases (e.g. a page-bg-coloured panel).
// /// Pass [border] to add a coloured outline (use PosTheme.border from the call site).
// class NeomorphismPanelOff extends StatelessWidget {
//   final Widget child;
//   final double? width;
//   final double? height;
//   final EdgeInsetsGeometry? padding;
...
class NeomorphismPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final baseColor = color ?? AppColors.oatmilk;
    final radius = borderRadius ?? BorderRadius.circular(22);
    final shadowDark = theme?.shadowDark ?? Colors.black.withValues(alpha: 0.68);
